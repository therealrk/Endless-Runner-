...
public class TileManager : MonoBehaviour
{
    ...
    {
        if (scoreSystem.distance <= (0+scoreSystem.distanceindent)*scoreSystem.distances)
        {
        ...
        if (scoreSystem.distance <= (1+ scoreSystem.distanceindent) * scoreSystem.distances && scoreSystem.distance >= (0 + scoreSystem.distanceindent) * scoreSystem.distances)
        {
